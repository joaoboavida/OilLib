...
message ( STATUS "aqui 0.1 - swig_source_file_path=${swig_source_file_path}") 
  GET_FILENAME_COMPONENT(swig_source_file_name_we "${infile}" NAME_WE)
message ( STATUS "aqui 0.1 - swig_source_file_name_we=${swig_source_file_name_we}") 
  GET_SOURCE_FILE_PROPERTY(swig_source_file_generated ${infile} GENERATED)
message ( STATUS "aqui 0.1 - swig_source_file_generated=${swig_source_file_generated}") 
  GET_SOURCE_FILE_PROPERTY(swig_source_file_cplusplus ${infile} CPLUSPLUS)
message ( STATUS "aqui 0.1 - swig_source_file_cplusplus=${swig_source_file_cplusplus}") 
  GET_SOURCE_FILE_PROPERTY(swig_source_file_flags ${infile} SWIG_FLAGS)
message ( STATUS "aqui 0.1 - swig_source_file_flags=${swig_source_file_flags}") 
  IF("${swig_source_file_flags}" STREQUAL "NOTFOUND")
    SET(swig_source_file_flags "")
  ENDIF()
  SET(swig_source_file_fullname "${infile}")
  IF(${swig_source_file_path} MATCHES "^${CMAKE_CURRENT_SOURCE_DIR}")
message ( STATUS "aqui 1") 
    STRING(REGEX REPLACE "^${CMAKE_CURRENT_SOURCE_DIR}" "" swig_source_file_relative_path "${swig_source_file_path}")
  ELSE()
    IF(${swig_source_file_path} MATCHES "^${CMAKE_CURRENT_BINARY_DIR}")
message ( STATUS "aqui 2") 
      STRING(REGEX REPLACE "^${CMAKE_CURRENT_BINARY_DIR}" "" swig_source_file_relative_path "${swig_source_file_path}")
      SET(swig_source_file_generated 1)
    ELSE()
message ( STATUS "aqui 3") 
      STRING(REGEX REPLACE "^${CMAKE_CURRENT_BINARY_DIR}" "" swig_source_file_relative_path "${swig_source_file_path}")
      SET(swig_source_file_generated 1)
      SET(swig_source_file_relative_path "${swig_source_file_path}")
      IF(swig_source_file_generated)
message ( STATUS "aqui 3.1") 
#        SET(swig_source_file_fullname "${CMAKE_CURRENT_BINARY_DIR}/${infile}")
        SET(swig_source_file_fullname "${infile}")
      ELSE()
message ( STATUS "aqui 3.2") 
